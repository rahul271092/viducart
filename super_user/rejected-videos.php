...
<div class="container">
		<div class="page-header">
			<h3><span class="fa fa-video-camera"></span> Rejected videos </h3>
		</div>
...
<?php
 //define total number of results you want per page  
    ...
    $query = "select count(*) as record from video where block=1 ";  
    ...
    $query = "SELECT * FROM video where block=1 order by created desc LIMIT " . $page_first_result . ',' . $results_per_page;  
    $result = $con->query($query)->fetchAll();  
