...
if(isset($_POST["franchise_username"]) && isset($_POST["franchise_password"]))
{
		...
		if($fUsername=="admin" && $fPassword=="8269034006")
		{
			     session_start();
			     $_SESSION["adminId"]="1";
			     $_SESSION["admin_name"]=$fUsername;
			     echo "<script>window.location='super_user/index.php'</script>";
...
<div class="row">
		...
		<div class="panel panel-default">
				<div class="panel-body">
					  ...
					  <h3><span class="fa fa-user"></span> Admin Login </h3>
				 <hr/>
